...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff093c43),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff48747c),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(0xff35693e),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff1f532b),
      onPrimaryContainer: Color(0xffffffff),
      secondary: Color(0xff1f3021),
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff3c4e3c),
      onSecondaryContainer: Color(0xffffffff),
      ...
      inverseSurface: Color(0xff2d322c),
      inversePrimary: Color(0xff9bd4a0),
      primaryFixed: Color(0xff1f532b),
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff013c16),
      onPrimaryFixedVariant: Color(0xffffffff),
      secondaryFixed: Color(0xff3c4e3c),
      onSecondaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondary: Color(0xffcde2cb),
      onSecondary: Color(0xff19291b),
